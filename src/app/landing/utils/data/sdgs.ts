...
export const sdgs: ISdg[] = [
  ...
  },
  {
    ...
    image: '/images/goals/F-WEB-Goal-6.png',
    isOpen: false
  },
  {
    ...
    image: '/images/goals/F-WEB-Goal-7.png',
    isOpen: false
  },
  {
    ...
    image: '/images/goals/F-WEB-Goal-8.png',
    isOpen: false
  },
  {
    name: 'Industrie, innovation et infrastructure',
    description:
      "Construire une infrastructure résiliente, promouvoir une industrialisation durable qui profite à tous et encourager l'innovation.",
    image: '/images/goals/F-WEB-Goal-9.png',
    isOpen: false
  },
  {
    name: 'Réduction des inégalités',
    description: "Réduire les inégalités dans les pays et d'un pays à l'autre.",
    image: '/images/goals/F-WEB-Goal-10.png',
    isOpen: false
  },
  {
  ...
  },
  {
    ...
    image: '/images/goals/F-WEB-Goal-13.png',
    isOpen: false
  },
  {
    name: 'Vie aquatique',
    description: 'Préserver et exploiter de manière durable les océans, les mers et les ressources marines.',
    image: '/images/goals/F-WEB-Goal-14.png',
    isOpen: false
  },
  {
    name: 'Vie terrestre',
    description: 'Préserver et restaurer les écosystèmes terrestres, en veillant à les exploiter de manière durable.',
    image: '/images/goals/F-WEB-Goal-15.png',
    isOpen: false
  },
  {
    name: 'Paix, justice et institutions efficaces',
    description:
      "Promouvoir des sociétés pacifiques et inclusives pour un développement durable, assurer l'accès à la justice pour tous et mettre en place des institutions efficaces, responsables et inclusives à tous les niveaux.",
    image: '/images/goals/F-WEB-Goal-16.png',
    isOpen: false
  },
  {
    ...
    image: '/images/goals/F-WEB-Goal-17.png',
    isOpen: false
  }
];
